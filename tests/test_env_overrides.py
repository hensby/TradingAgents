...
def test_no_env_uses_built_in_defaults(monkeypatch):
    ...
    assert dc.DEFAULT_CONFIG["report_dir"].endswith("/.tradingagents/reports")
...
def test_string_overrides(monkeypatch):
    dc = _reload_with_env(
        ...
        TRADINGAGENTS_REPORT_DIR="/tmp/tradingagents-reports",
    )
    ...
    assert dc.DEFAULT_CONFIG["report_dir"] == "/tmp/tradingagents-reports"
